...
keymap("n", "<Left>", "<CMD>wincmd h<CR>", { noremap = true, silent = true, desc = "Workspace left" })
keymap("n", "<Right>", "<CMD>wincmd l<CR>", { noremap = true, silent = true, desc = "Workspace right" })
keymap("n", "<Up>", "<CMD>wincmd k<CR>", { noremap = true, silent = true, desc = "Workspace up" })
keymap("n", "<Down>", "<CMD>wincmd j<CR>", { noremap = true, silent = true, desc = "Workspace down" })
