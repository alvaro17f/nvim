  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        vim.keymap.set("n", "gf", "<cmd>Telescope lsp_type_definitions<CR>", opts) -- show lsp type definitions
        ...
        vim.keymap.set("n", "gb", "<cmd>Telescope diagnostics bufnr=0<CR>", opts) -- show  diagnostics for file
